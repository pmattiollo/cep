...
@FacesConverter(value= "ConversorSample")
public class SampleConverter implements Converter {

	private SampleDAO sampleDAO = Beans.getReference(SampleDAO.class);
		...
		Object ret = null;
			if (component instanceof PickList) {
				...
				for (Object o : dl.getSource()) {
					String id = String.valueOf(((Sample) o).getId());
					if (value.equals(id)) {
						ret = o;
						break;
					}
	...
	public String getAsString(FacesContext context, UIComponent component,
		...
		try{
			if (value == null || value.equals("")) {
				...
				return String.valueOf(((Sample) value).getId());
			}
		}catch (Exception e) {
			e.printStackTrace();
			return "";
