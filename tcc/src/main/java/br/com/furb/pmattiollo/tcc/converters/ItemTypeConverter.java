...
@FacesConverter(value= "ConversorItemType")
public class ItemTypeConverter implements Converter {

	private ItemTypeDAO itemTypeDAO = Beans.getReference(ItemTypeDAO.class);
		...
		Object ret = null;
			if (component instanceof PickList) {
				...
				for (Object o : dl.getSource()) {
					String id = String.valueOf(((ItemType) o).getId());
					if (value.equals(id)) {
						ret = o;
						break;
					}
	...
	public String getAsString(FacesContext context, UIComponent component,
		...
		try{
			if (value == null || value.equals("")) {
				...
				return String.valueOf(((ItemType) value).getId());
			}
		}catch (Exception e) {
			e.printStackTrace();
			return "";
